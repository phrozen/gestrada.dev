...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"gestrada.dev","description":"Thoughts on Computer Science, Clever Algorithms, System Design and Generative Art.","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Home","link":"/"},{"text":"About","link":"/about"}],"socialLinks":[{"icon":"github","link":"https://github.com/phrozen"},{"icon":"x","link":"https://x.com/phrzn"}],"search":{"provider":"local"},"footer":{"copyright":"© 2026 Guillermo Estrada"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$u = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.xrcYOpGc.js"));
...
const IconBrandGithub = markRaw({ name: "tabler-brand-github", render: render$1 });
const _sfc_main$1 = {
  __name: "Sketch",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "sketch-wrapper" }, _attrs))} data-v-9c5aabb4><div class="sketch-header" data-v-9c5aabb4><span class="sketch-title" data-v-9c5aabb4>${ssrInterpolate(__props.title)}</span>`);
      if (__props.source) {
        _push(`<a${ssrRenderAttr("href", githubUrl.value)} target="_blank" rel="noopener noreferrer" class="sketch-link" data-v-9c5aabb4>`);
        _push(ssrRenderComponent(unref(IconBrandGithub), null, null, _parent));
        _push(` View on GitHub </a>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`<div class="sketch-footer" data-v-9c5aabb4>${ssrInterpolate(__props.description)}</div></div>`);
    };
  }
};
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/Sketch.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        ref: sketchContainer,
        class: ["p5-container", { "pixelated": props.pixelated }]
      }, _attrs))} data-v-9f35ec60></div>`);
    };
  }
};
const _sfc_setup = _sfc_main.setup;
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".vitepress/theme/components/P5Embed.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
